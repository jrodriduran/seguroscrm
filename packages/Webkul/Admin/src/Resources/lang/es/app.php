...
return [
    ...
    'contacts' => [
        ...
        'organizations' => [
            'index' => [
                'title' => 'Aseguradoras y Compañías',
                'create-btn' => 'Crear Aseguradora',
                'create-success' => 'Aseguradora creada con éxito.',
                'update-success' => 'Aseguradora actualizada con éxito.',
                'delete-success' => 'Aseguradora eliminada con éxito.',
                'delete-failed' => 'La aseguradora no se puede eliminar.',
                'datagrid' => [
                    'delete' => 'Eliminar',
                    'edit' => 'Editar',
                    'id' => 'ID',
                    'name' => 'Aseguradora / Organización',
                    'carrier_code' => 'Código / NAIC',
                    'support_phone' => 'Teléfono de Soporte',
                    'broker_portal' => 'Portal de Agentes',
                    'open_portal' => 'Abrir Portal',
                    'persons-count' => 'Asegurados / Contactos',
                ],
            ],
            'create' => [
                'title' => 'Crear Aseguradora / Organización',
                'save-btn' => 'Guardar Aseguradora',
            ],
            'edit' => [
                'title' => 'Editar Aseguradora / Organización',
                'save-btn' => 'Guardar Aseguradora',
            ],
        ],
    ],
        'products' => [
        'index' => [
            'title'          => 'Planes y Productos de Seguro',
            'create-btn'     => 'Crear Plan / Producto',
            'create-success' => 'Plan creado con éxito.',
            'update-success' => 'Plan actualizado con éxito.',
            'delete-success' => 'Plan eliminado con éxito.',
            'delete-failed'  => 'No se puede eliminar el plan.',
            'datagrid' => [
                'allocated' => 'Asignado',
                'delete'    => 'Eliminar',
                'edit'      => 'Editar',
        ...
        'create' => [
            'title'    => 'Crear Plan / Producto',
            'general'  => 'Información General',
            'price'    => 'Prima / Costo Mensual',
            'save-btn' => 'Guardar Plan',
        ],
        'edit' => [
            'title'    => 'Editar Plan / Producto',
            'general'  => 'Información General',
            'price'    => 'Prima / Costo Mensual',
            'save-btn' => 'Guardar Plan',
        ],
    ...
    // Insurance CRM Fallback Translations
'pipelines' => [
