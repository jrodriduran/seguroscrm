    ...
    'contacts' => [
        ...
        'organizations' => [
            'index' => [
                ...
                'create-btn' => 'Create Carrier',
                'create-success' => 'Carrier created successfully.',
                'update-success' => 'Carrier updated successfully.',
                'delete-success' => 'Carrier deleted successfully.',
                'delete-failed' => 'Carrier cannot be deleted.',
                'datagrid' => [
                    'delete' => 'Delete',
                    'edit' => 'Edit',
                    'id' => 'ID',
                    'name' => 'Carrier Name',
                    'carrier_code' => 'NAIC / Code',
                    'support_phone' => 'Support Phone',
                    'broker_portal' => 'Broker Portal',
                    'open_portal' => 'Open Portal',
                    'persons-count' => 'Members / Persons',
                ],
            ],
            'create' => [
                'title' => 'Create Carrier / Organization',
                'save-btn' => 'Save Carrier',
            ],
            'edit' => [
                'title' => 'Edit Carrier / Organization',
                'save-btn' => 'Save Carrier',
            ],
        ],
    ],
        'products' => [
        'index' => [
            'title'          => 'Insurance Plans & Products',
            'create-btn'     => 'Create Plan / Product',
            ...
            'delete-failed'  => 'Product cannot be deleted.',
            'datagrid' => [
                'allocated' => 'Allocated',
                'delete'    => 'Delete',
                'edit'      => 'Edit',
