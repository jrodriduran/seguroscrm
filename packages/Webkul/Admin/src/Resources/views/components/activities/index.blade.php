            ...
            data() {
                return {
                    ...
                    typeClasses: {
                        ...
                        consent_request: 'icon-attribute bg-purple-200 text-purple-900 dark:!text-purple-900',
                        soa: 'icon-quote bg-indigo-200 text-indigo-900 dark:!text-indigo-900',
                        docs_verification: 'icon-file bg-amber-200 text-amber-900 dark:!text-amber-900',
                        application_submit: 'icon-tick bg-emerald-200 text-emerald-900 dark:!text-emerald-900',
                        renewal_review: 'icon-notification bg-sky-200 text-sky-900 dark:!text-sky-900',
